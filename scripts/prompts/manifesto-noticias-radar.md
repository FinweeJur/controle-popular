...
- **`veiculo`** (5 valores distintos): ex: "Guaicuy — Assessoria dos Atingidos pela Vale", "Diário do Comércio", "Blog do Pedlowski", "JOTA Info", "O Fator"
- **`fonte_id`** (2 valores distintos): ex: "guaicuy", "google-noticias"

# Análise de vício legislativo / indício de inconstitucionalidade — Betim (3106705)
...
## Depois de responder tudo
    ...
    python -m etl.importar_analises_vicio --id-municipio 3106705 --dir calibracao_vicio/betim

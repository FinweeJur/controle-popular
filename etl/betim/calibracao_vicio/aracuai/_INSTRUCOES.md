# Análise de vício legislativo / indício de inconstitucionalidade — Araçuaí (3103405)
...
## Depois de responder tudo
    ...
    python -m etl.importar_analises_vicio --id-municipio 3103405 --dir calibracao_vicio/aracuai

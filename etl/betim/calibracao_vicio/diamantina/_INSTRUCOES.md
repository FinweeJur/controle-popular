# Análise de vício legislativo / indício de inconstitucionalidade — Diamantina (3121605)
...
## Depois de responder tudo
    ...
    python -m etl.importar_analises_vicio --id-municipio 3121605 --dir calibracao_vicio/diamantina

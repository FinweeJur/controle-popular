# Análise de vício legislativo / indício de inconstitucionalidade — São Paulo (3550308)
...
## Depois de responder tudo
    ...
    python -m etl.importar_analises_vicio --id-municipio 3550308 --dir calibracao_vicio/sp

...
export const REGISTRY_FONTES: Record<string, FonteDef> = {
  ...
  "pncp-contratos": {
    ...
    urlOficial: "https://www.gov.br/pncp/pt-br",
  ...
  "socios-vale": {
    slug: "socios-vale",
    nome: "Socios da Vale S.A. (brasil.io)",
    orgao: "Receita Federal / brasil.io",
    esfera: "federal",
    frente: "empresas",
    descricao: "Diretores e presidente da Vale S.A. com CPF mascarado (6 registros, set/2020). Ressalva: quadro societario potencialmente desatualizado.",
    urlOficial: "https://brasil.io/dataset/socios-brasil/socios/",
    licenca: "dados-abertos-gov",
    frequenciaAtualizacao: "estatica",
    camada: "data-json",
    caminhoArquivo: "apps/web/data/socios-vale.json",
    requerToken: true,
    variavelToken: "BRASILIO_API_TOKEN",
    ressalvaEditorial: "Dataset de set/2020. O quadro societario pode nao refletir mudancas posteriores.",
  },
  // ─── FRENTE: AMBIENTAL — CRIMES SOCIOAMBIENTAIS EXPANSÃO ───
  "mpmg-coerdoce": {
    slug: "mpmg-coerdoce",
    nome: "MPMG — Procuradoria de Justiça de Meio Ambiente (Coerdoce)",
    orgao: "Ministério Público de Minas Gerais (MPMG)",
    esfera: "estadual",
    frente: "ambiental",
    descricao: "Informações Técnico-Jurídicas (ITJs), inquéritos civis e relatórios de fiscalização sobre os rompimentos de Fundão e Córrego do Feijão.",
    urlOficial: "https://www.mpmg.mp.br/portal/menu/comunicacao/noticias/",
    licenca: "lei-acesso-informacao",
    frequenciaAtualizacao: "mensal",
    camada: "data-json",
    caminhoArquivo: "apps/web/data/mpmg-coerdoce.json",
    constanteCobertura: "COBERTURA_MPMG_COERDOCE",
    rotaPortal: "/ambiental/crimes-socioambientais",
    ressalvaEditorial: "Notas técnicas ministeriais — a fonte não fornece excerpt. Metadado + link, nunca o arquivo (Lei 9.610/98).",
  },
  "mpmg-nucard": {
    slug: "mpmg-nucard",
    nome: "MPMG — Núcleo de Acompanhamento de Reparações por Desastres (NUCARD)",
    orgao: "Ministério Público de Minas Gerais (MPMG)",
    esfera: "estadual",
    frente: "ambiental",
    descricao: "Acompanhamento dos acordos de reparação de Mariana (2015) e Brumadinho (2019). Resolução PGJ nº 6/2025.",
    urlOficial: "https://www.mpmg.mp.br/portal/menu/areas-de-atuacao/reparacao-por-desastres/",
    licenca: "lei-acesso-informacao",
    frequenciaAtualizacao: "mensal",
    camada: "data-json",
    caminhoArquivo: "apps/web/data/mpmg-nucard.json",
    constanteCobertura: "COBERTURA_MPMG_NUCARD",
    rotaPortal: "/ambiental/crimes-socioambientais",
    ressalvaEditorial: "Dados baseados em informações públicas do NUCARD. Scraping real de Notas Técnicas requer Playwright (sistema KORA).",
  },
  "mpf-grandes-casos": {
    slug: "mpf-grandes-casos",
    nome: "MPF — Procuradoria-Geral da República (Grandes Casos)",
    orgao: "Ministério Público Federal (MPF)",
    esfera: "federal",
    frente: "ambiental",
    ...
    frequenciaAtualizacao: "semanal",
    camada: "data-json",
    caminhoArquivo: "apps/web/data/mpf-grandes-casos.json",
    constanteCobertura: "COBERTURA_MPF_GRANDES_CASES",
    rotaPortal: "/ambiental/crimes-socioambientais",
    ressalvaEditorial: "Acordos judiciais e pareceres técnicos. Caso emblemático com repercussão internacional (STF, High Court Londres).",
  },
  "dpu-comite-tematico": {
    slug: "dpu-comite-tematico",
    nome: "DPU — Comitê Temático Rio Doce/Brumadinho",
    orgao: "Defensoria Pública da União (DPU)",
    esfera: "federal",
    frente: "ambiental",
    descricao: "Notas técnicas sobre atingidos, habitação, renda e saúde no âmbito da reparação dos rompimentos de Fundão e Córrego do Feijão.",
    urlOficial: "https://direitoshumanos.dpu.def.br/comite-tematico-especializado-rio-doce-brumadinho/",
    licenca: "lei-acesso-informacao",
    frequenciaAtualizacao: "semanal",
    camada: "data-json",
    caminhoArquivo: "apps/web/data/dpu-comite-tematico.json",
    constanteCobertura: "COBERTURA_DPU_COMITE_TEMATICO",
    rotaPortal: "/ambiental/crimes-socioambientais",
    ressalvaEditorial: "Foco em direitos humanos dos atingidos. Notas técnicas sem corpo publicado — metadado + link.",
  },
  "dpmg-notas": {
    slug: "dpmg-notas",
    nome: "DPMG — Defensoria Pública de Minas Gerais",
    orgao: "Defensoria Pública de Minas Gerais (DPMG)",
    esfera: "estadual",
    frente: "ambiental",
    descricao: "Atuação em comitês do Acordo de Reparação, notas sobre atingidos e acompanhamento da execução da reparação.",
    urlOficial: "https://defensoria.mg.def.br/",
    licenca: "lei-acesso-informacao",
    frequenciaAtualizacao: "mensal",
    camada: "data-json",
  ...
  "quadrilatero-ferrifero": {
    slug: "quadrilatero-ferrifero",
    nome: "Quadrilátero Ferrífero — Mina Apolo, Operação Rejeito",
    orgao: "SEMAD / FEAM / IEF / ICMBio / IBAMA / PF",
    esfera: "federal",
    frente: "ambiental",
    descricao: "Conflito Mina Apolo vs. Parque Serra do Gandarela. Operação Rejeito (PF, 2025). Rola-Moça e outros conflitos de mineração no Vale do Aço.",
    urlOficial: "https://www.gov.br/ibama/pt-br/assuntos/meio-ambiente/areas-protegidas/icmbio",
    licenca: "dados-abertos-gov",
    frequenciaAtualizacao: "semanal",
    camada: "data-json",
  ...
  "vale-sigma-lithium": {
    slug: "vale-sigma-lithium",
    nome: "Vale S.A. e Sigma Lithium — Documentos e Ações",
    orgao: "Vale S.A. / Sigma Lithium Corporation / SEC / High Court / ANM",
    esfera: "internacional",
    frente: "ambiental",
    descricao: "Acordos de reparação (Fundão, Brumadinho), ações internacionais (Londres, Amsterdã, SEC), fiscalizações e TACs da Sigma Lithium no Vale do Jequitinhonha.",
    urlOficial: "https://vale.com/en/sustainability",
    licenca: "lei-acesso-informacao",
    frequenciaAtualizacao: "mensal",
    camada: "data-json",
    caminhoArquivo: "apps/web/data/vale-sigma-lithium.json",
    rotaPortal: "/ambiental/crimes-socioambientais",
    ressalvaEditorial: "Documentos públicos de empresas. Acordos judiciais e regulatórios com repercussão internacional.",
  },
  "casos-nacionais-crimes": {
    slug: "casos-nacionais-crimes",
    nome: "Casos Nacionais de Crimes Socioambientais",
    orgao: "MPF, STF, STJ, ANM, CGU, IBAMA",
    esfera: "federal",
    frente: "ambiental",
    descricao: "Casos de escala nacional: Fundão (2015), Brumadinho (2019), Pingo d'Água (2024), Xikrin do Cateté, APA Tapajós, Extremo Sul da BA, BHP Londres, Vale SEC/EUA.",
    urlOficial: "https://www.mpf.mp.br/atuacao/grandes-casos",
    licenca: "lei-acesso-informacao",
    frequenciaAtualizacao: "mensal",
    camada: "data-json",
  ...
  "acoes-coletivas-justica": {
    slug: "acoes-coletivas-justica",
    nome: "Ações Coletivas das Instituições de Justiça",
    orgao: "MPF, MPMG, DPU, DPMG, MPES, MPBA, STF, STJ",
    esfera: "federal",
    frente: "ambiental",
    descricao: "ACPs, TACs, medidas cautelares e temas repetitivos do STJ (707, 1.204, 681, 438) e repercussão geral do STF (1.194) sobre danos ambientais.",
    urlOficial: "https://www.cnj.jus.br/programas-e-acoes/sirenejud/",
    licenca: "dominio-publico",
    frequenciaAtualizacao: "semanal",
    camada: "data-json",

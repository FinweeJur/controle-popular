...
export const ZONAS: Zona[] = [
  ...
  },
  {
    ...
    // ⟲ 02/09, copy v6: o título vira três verbos de responsabilidade —
    // quem autoriza, quem licencia, quem responde. A descrição continua
    // sendo inventário com tamanho (reuniões, licenças, normas), nada de
    // promessa.
    titulo: "Quem autoriza, quem licencia, quem responde",

  ...
  const secoes = [
    ...
    },
    {
      ...
      topicos: [
        ...
        { href: "/ambiental/mariana", titulo: "Quero o Acordo de Mariana", descricao: "Execução de R$ 677 mi da repactuação do Rio Doce.", cor: "var(--cp-tertiary)", badge: "Acao", icon: <Leaf size={14} /> },

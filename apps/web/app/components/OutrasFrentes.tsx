import { outrasZonas, type ZonaId } from "@/lib/zonas";

/**
 * Remissão cruzada entre as três frentes, para o pé da home de cada zona.
 *
 * Pedido do usuário: toda home tem de apontar para as outras duas —
  ...
  return (
    <section className="mt-16 border-t border-border pt-8">
      ...
      <p className="mt-2 max-w-2xl text-[.95em] text-text-soft">
        O poder público decide em três lugares diferentes, e o Controle Popular acompanha os
        três. Acompanhar só um deixa boa parte da história de fora.
      </p>

...
import PedidoLAI from "@/app/betim/components/PedidoLAI";
import TabelaScroll from "@/app/betim/components/TabelaScroll";
import AreasAtuacao from "@/app/betim/components/charts/AreasAtuacao";
...
export default async function ContratosPage({
  ...
  const exportHref = withBasePath(`/api/contratos?${exportQs.toString()}`);
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-8">
      ...
      <div className="mb-2 flex flex-wrap items-end justify-between gap-4">
        ...
        {/* `<a>` cru (não `<Link>`): é download de rota de API, e `exportHref`
            já traz o basePath via `withBasePath()`. Um `<Link>` prependeria o

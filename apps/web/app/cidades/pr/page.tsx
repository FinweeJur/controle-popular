...
export default async function PageCidadesSP() {
  ...
  const cartao = {
    ...
    descricao: "Cidades em Paraná mapeadas pelo IBGE",
  };
  ...
  return (
    <article className="mx-auto max-w-4xl px-4 py-8">
      <header className="mb-8">
        ...
        <h1 className="mt-2 text-3xl font-bold">Municípios de Paraná</h1>
        <p className="mt-3 text-text_soft">
          Todos os 645 municípios de Paraná mapeados via API do IBGE. Dados atualizados

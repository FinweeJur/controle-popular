...
- **Status da Execução (07/09/2026)**: Dataset expandido para 243 pares cívicos e validado por `scripts/enriquecer-dataset-sabia.py`. Automação de treino e harness de avaliação em `scripts/treinar-sabia-automacao.py` aprovou 10/10 testes capitais (100% acurácia, 0% alucinação) cobrindo os R$ 251 bi, 199 cidades, TJMG, MPMG, DPMG, ICMS, Mariana R$ 171 bi, Brumadinho, Diamantina, Kit Guias AppLivre e as Top Empresas/Fundos e Governança/ESG.

# Plano — Biblioteca unificada de documentos dos desastres de Mariana e Brumadinho
...
- [A página /ambiental/desastres-minerarios](#a-página-ambientaldesastres-minerarios)
...
4. Rota: **`/ambiental/desastres-minerarios`**.
...
## A página /ambiental/desastres-minerarios
...
- `/paraopeba/biblioteca/page.tsx` vira página-ponte: explica que a biblioteca
  ...
  `/ambiental/desastres-minerarios?desastre=brumadinho`.
...
Escrito em 31/08/2026 na sessão que criou a rota `/ambiental/desastres-minerarios`.

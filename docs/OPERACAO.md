...
3. Varra dado pessoal **antes de commitar** dado coletado: `apps/web/lib/sem-cpf-no-repo.test.ts` valida por mod-11 todo campo de texto; CPF em ementa oficial é redigido na própria ingestão.

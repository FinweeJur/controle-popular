...
- [Propósito](#propósito)
- [Por que esta fonte entrou no portal](#por-que-esta-fonte-entrou-no-portal)
- [Os números de MG](#os-números-de-mg)
- [Top 10 incentivadores domiciliados em MG, por valor doado](#top-10-incentivadores-domiciliados-em-mg-por-valor-doado)
- [Top 10 municípios de MG por valor captado](#top-10-municípios-de-mg-por-valor-captado)
- [As armadilhas — leia antes de escrever qualquer frase com esta fonte](#as-armadilhas-leia-antes-de-escrever-qualquer-frase-com-esta-fonte)
- [Dado pessoal: o que a fonte mascara, e o que ela deixou passar](#dado-pessoal-o-que-a-fonte-mascara-e-o-que-ela-deixou-passar)
- [Como os arquivos estão gravados](#como-os-arquivos-estão-gravados)
- [As medidas cruas da sonda](#as-medidas-cruas-da-sonda)
- [A tela: por que ela NÃO foi feita nesta rodada](#a-tela-por-que-ela-não-foi-feita-nesta-rodada)

## Propósito

> Fonte: API SALIC do Ministério da Cultura, `https://api.salic.cultura.gov.br/api/v1`, pública e sem > chave. Coleta de **2026-08-15** por > `scripts/coletar-salic-rouanet.mts`. Todo número desta página saiu dessa > coleta; nenhum foi estimado.

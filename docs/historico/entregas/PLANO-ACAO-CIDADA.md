...
- [Propósito](#propósito)
- [O pedido, em uma frase](#o-pedido-em-uma-frase)
- [O requisito que decide a arquitetura inteira](#o-requisito-que-decide-a-arquitetura-inteira)
- [O roteiro — entrevista, não formulário](#o-roteiro-entrevista-não-formulário)
- [Provas — a parte mais útil e a mais perigosa](#provas-a-parte-mais-útil-e-a-mais-perigosa)
- [Para onde enviar — e o roteamento por resposta](#para-onde-enviar-e-o-roteamento-por-resposta)
- [Fases de implementação](#fases-de-implementação)
- [Riscos](#riscos)
- [Fontes consultadas nesta pesquisa](#fontes-consultadas-nesta-pesquisa)

...
- [Propósito](#propósito)
- [1. Os quatro arquivos que já existem](#1-os-quatro-arquivos-que-já-existem)
- [2. Correção do classificador — a Lei 726/2025 de Araçuaí achada e consertada](#2-correção-do-classificador-a-lei-7262025-de-araçuaí-achada-e-consertada)
- [3. Alerta novo: normas que mexem em área protegida](#3-alerta-novo-normas-que-mexem-em-área-protegida)
- [4. Quilombola × mancha de inundação](#4-quilombola-mancha-de-inundação)
- [5. Território (indígena + quilombola) × mineração (SIGMINE)](#5-território-indígena-quilombola-mineração-sigmine)
- [5b. Entradas em `CAMADAS` (bloco de `assunto`, para o painel)](#5b-entradas-em-camadas-bloco-de-assunto-para-o-painel)
- [6. Resumo para quem só quer os números](#6-resumo-para-quem-só-quer-os-números)

## Propósito

> ## ✅ ENTREGUE em 15/08/2026 — e três números deste documento estavam VENCIDOS > > As quatro camadas foram registradas no `config.js` (commit `d1777b3`) e estão > na tela, na seção "Território indígena, mineração e barragens". **Mas os > textos propostos aqui não puderam ser colados como estavam...

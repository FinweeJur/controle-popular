...
- [Propósito](#propósito)
- [O obstáculo, primeiro](#o-obstáculo-primeiro)
- [Renomear URL](#renomear-url)
- [Apagar página](#apagar-página)
- [Segurança](#segurança)
- [Fases, em ordem de valor](#fases-em-ordem-de-valor)
- [O que fica de fora, de propósito](#o-que-fica-de-fora-de-propósito)

## Propósito

> Números deste plano medidos em 2026-08-13, contra `logs/rotina-*.log` > (histórico de builds reais desta máquina) e contra o código do repositório. > Onde não medi, digo que não medi.

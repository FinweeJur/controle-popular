...
- [Propósito](#propósito)
- [0. Por que isto não é "mais um alerta"](#0-por-que-isto-não-é-mais-um-alerta)
- [1. ⚠️ A armadilha que este documento existe para não deixar repetir](#1-a-armadilha-que-este-documento-existe-para-não-deixar-repetir)
- [2. Os arquivos](#2-os-arquivos)
- [3. O insumo: a faixa vem PRONTA, não é buffer nosso](#3-o-insumo-a-faixa-vem-pronta-não-é-buffer-nosso)
- [4. O que foi medido](#4-o-que-foi-medido)
- [5. Método, e o que ele não faz](#5-método-e-o-que-ele-não-faz)
- [6. Para colar em `config.js`](#6-para-colar-em-configjs)
- [7. Lacunas declaradas desta entrega](#7-lacunas-declaradas-desta-entrega)

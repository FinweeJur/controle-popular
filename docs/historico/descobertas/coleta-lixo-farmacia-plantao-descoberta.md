...
- [Propósito](#propósito)
- [Resumo](#resumo)
- [Betim — coleta de lixo — CONFIRMADO, coletor escrito](#betim-coleta-de-lixo-confirmado-coletor-escrito)
- [Belo Horizonte — coleta de lixo — fonte rica, coletor NÃO escrito](#belo-horizonte-coleta-de-lixo-fonte-rica-coletor-não-escrito)
- [São Paulo — coleta de lixo — ferramenta existe, API não identificada](#são-paulo-coleta-de-lixo-ferramenta-existe-api-não-identificada)
- [Araçuaí, Diamantina, Itinga — coleta de lixo — não encontrado](#araçuaí-diamantina-itinga-coleta-de-lixo-não-encontrado)
- [Todas as 6 cidades — farmácia de plantão — não encontrado](#todas-as-6-cidades-farmácia-de-plantão-não-encontrado)

## Propósito

> Sessão 2026-08-11. Ponto de partida: nenhuma das 6 cidades (Araçuaí, Belo > Horizonte, Betim, Diamantina, Itinga, São Paulo) tinha fonte confirmada > pra `coleta_lixo` ou `farmacias_plantao`. Este arquivo registra o que foi > tentado por cidade/tema, pra quem retomar não repetir o caminho.

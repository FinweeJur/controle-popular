...
- [Propósito](#propósito)
- [DoD da F0 (o que esta fase tinha de entregar)](#dod-da-f0-o-que-esta-fase-tinha-de-entregar)
- [1. A fonte-espinha-dorsal: Senado, Mensagens de indicação ✅](#1-a-fonte-espinha-dorsal-senado-mensagens-de-indicação)
- [2. Bloqueios confirmados — testados com User-Agent de browser completo](#2-bloqueios-confirmados-testados-com-user-agent-de-browser-completo)
- [3. `[VERIFY]` do plano — todos fechados](#3-verify-do-plano-todos-fechados)
- [4. BrasilAPI — avaliado a pedido do usuário](#4-brasilapi-avaliado-a-pedido-do-usuário)
- [5. Disciplina de coleta (herdada do `/congresso`)](#5-disciplina-de-coleta-herdada-do-congresso)
- [7. `magistrados.url_foto` — investigado em 2026-08-09, sem endpoint achado](#7-magistradosurl-foto-investigado-em-2026-08-09-sem-endpoint-achado)
- [8. Artefatos gerados nesta fase](#8-artefatos-gerados-nesta-fase)

## Propósito

> **Estado:** concluída em 2026-07-24. Todo endpoint aqui foi chamado ao vivo; o que não funcionou está marcado como bloqueio confirmado, não suposição. Números reproduzíveis com `python -m etl.senado.indicacoes --descobrir --de 2003 --ate 2026`. > > **Arquivo histórico, anterior à unificação em ...

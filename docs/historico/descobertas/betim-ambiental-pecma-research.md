...
- [Propósito](#propósito)
- [PECMA (Programa Estadual de Conversão de Multas Ambientais)](#pecma-programa-estadual-de-conversão-de-multas-ambientais)
- [MPMG — "Desativando Bombas-Relógio" (barragens upstream)](#mpmg-desativando-bombas-relógio-barragens-upstream)
- [TACs ambientais (MPMG)](#tacs-ambientais-mpmg)
- [Condenações judiciais ambientais (RMBH/Betim)](#condenações-judiciais-ambientais-rmbhbetim)
- [Recomendação](#recomendação)

## Propósito

Pedido do usuário: mapear fontes públicas para PECMA, condenações judiciais ambientais e TACs do MPMG envolvendo Betim/RMBH, antes de decidir o escopo da futura seção "Ambiental / Proteção Civil" (F9). Achados verificados ao vivo (WebFetch/curl), não suposição.

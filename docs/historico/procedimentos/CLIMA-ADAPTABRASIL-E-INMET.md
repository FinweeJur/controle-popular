...
- [Propósito](#propósito)
- [1. Resumo](#1-resumo)
- [2. ⚠️ A carga NÃO rodou — e por quê](#2-a-carga-não-rodou-e-por-quê)
- [3. AdaptaBrasil — 853 municípios, 8 indicadores, 6.824 linhas](#3-adaptabrasil-853-municípios-8-indicadores-6824-linhas)
- [4. INMET avisos ativos — 9 avisos, 4 sobre MG](#4-inmet-avisos-ativos-9-avisos-4-sobre-mg)
- [5. O que ficou para a próxima rodada](#5-o-que-ficou-para-a-próxima-rodada)

## Propósito

Primeira fatia de `docs/PLANO-BASES-CLIMA-E-RISCO.md`, a rodada que o plano coloca em primeiro e terceiro lugares da lista de prioridade: **AdaptaBrasil** (índice de risco climático por município, licença clara, 853 cidades numa chamada) e **INMET avisos ativos** (o "agora" que nenhuma outra font...

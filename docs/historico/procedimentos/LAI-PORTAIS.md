...
- [Propósito](#propósito)
- [Aviso de procedência — leia antes do resto](#aviso-de-procedência-leia-antes-do-resto)
- [As 6 cidades do eixo Cidades (conferido no banco)](#as-6-cidades-do-eixo-cidades-conferido-no-banco)
- [O que já existe no produto (não é um pedido redigido, é um gerador)](#o-que-já-existe-no-produto-não-é-um-pedido-redigido-é-um-gerador)
- [Nível municipal](#nível-municipal)
- [Nível estadual (Minas Gerais)](#nível-estadual-minas-gerais)
...
> **Antes de usar:** todo item aqui foi aberto e conferido em **2026-08-13**, > exceto onde marcado. Contato de órgão público muda com frequência — se este > documento tiver mais de alguns meses quando você o ler, **reabra o link antes > de mandar alguém até o balcão**. O que não foi possível con...

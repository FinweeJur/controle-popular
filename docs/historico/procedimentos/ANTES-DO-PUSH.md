...
- [Propósito](#propósito)
- [Ligue o hook — uma vez por clone, em cada máquina](#ligue-o-hook-uma-vez-por-clone-em-cada-máquina)
- [As três camadas, e por que são três](#as-três-camadas-e-por-que-são-três)
- [O que ele barra](#o-que-ele-barra)
- [Por que isto existe](#por-que-isto-existe)
- [Se acusar falso positivo](#se-acusar-falso-positivo)
- [Uma armadilha já paga, para ninguém repetir](#uma-armadilha-já-paga-para-ninguém-repetir)
- [Antes do build: derrube o seu próprio wrangler](#antes-do-build-derrube-o-seu-próprio-wrangler)

## Propósito

**Este repositório é PÚBLICO** (`gh repo view --json visibility` → `PUBLIC`). Tudo que sai daqui é permanente: mesmo apagando depois, o GitHub mantém o commit órfão acessível por hash, e quem clonou continua com a cópia.

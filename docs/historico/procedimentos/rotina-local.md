...
- [Propósito](#propósito)
- [O que roda, e quando](#o-que-roda-e-quando)
- [A trava, que é a razão de tudo](#a-trava-que-é-a-razão-de-tudo)
- [A armadilha que derrubou a primeira execução automática](#a-armadilha-que-derrubou-a-primeira-execução-automática)
- [Por que ela LÊ os workflows em vez de repetir os comandos](#por-que-ela-lê-os-workflows-em-vez-de-repetir-os-comandos)
- [O corpus que ficava velho em silêncio (corrigido em 15/08/2026)](#o-corpus-que-ficava-velho-em-silêncio-corrigido-em-15082026)
- [O que ela nunca faz](#o-que-ela-nunca-faz)
- [Usar à mão](#usar-à-mão)
- [O que a máquina precisa ter](#o-que-a-máquina-precisa-ter)
- [O que sobrou agendado no GitHub, e por quê](#o-que-sobrou-agendado-no-github-e-por-quê)
- [Quando conferir se está funcionando](#quando-conferir-se-está-funcionando)

## Propósito

> Escrita em 2026-08-10, quando o §20 do plano registrou a dívida mais > perigosa da lista: **o site estava correto e no ar, mas só mudava quando > alguém rodava o build à mão.** Os 6 workflows de ETL seguiam agendados no > GitHub apontando para a Neon, que não é mais o banco — acordavam todo dia...

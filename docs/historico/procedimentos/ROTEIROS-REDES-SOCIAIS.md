...
- [Propósito](#propósito)
- [⚠️ Antes de qualquer coisa: gravar depende do site estar no ar](#antes-de-qualquer-coisa-gravar-depende-do-site-estar-no-ar)
- [O que mudou em relação à proposta anterior](#o-que-mudou-em-relação-à-proposta-anterior)
- [⚠️ Três avisos de honestidade (leia antes de gravar)](#três-avisos-de-honestidade-leia-antes-de-gravar)
- [Banco de CTAs — 3 variantes](#banco-de-ctas-3-variantes)
- [Guia de produção (comum aos seis)](#guia-de-produção-comum-aos-seis)
- [Ganchos que eu descartei, e por quê](#ganchos-que-eu-descartei-e-por-quê)
- [O que convém corrigir no portal ANTES de gravar](#o-que-convém-corrigir-no-portal-antes-de-gravar)
- [Relacionados](#relacionados)

## Propósito

> **Seis roteiros verticais (9:16), até 60 s cada**, um por frente do portal. > Item **N6** de `docs/PLANO-2026-08-15.md`. > > **Nota de método.** Todo número citado num roteiro foi medido em > **15/08/2026**, contra os arquivos deste repositório, ou copiado de um > documento de `docs/` **com a d...

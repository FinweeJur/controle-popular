...
- [Propósito](#propósito)
- [A regra que resolve 90% dos conflitos: cada worktree tem SEU território](#a-regra-que-resolve-90-dos-conflitos-cada-worktree-tem-seu-território)
- [Numeração de migration: reserve ANTES de escrever](#numeração-de-migration-reserve-antes-de-escrever)
- [Como commitar](#como-commitar)
- [Como mergear](#como-mergear)
- [O que verificar depois do merge, sempre](#o-que-verificar-depois-do-merge-sempre)
- [A regra que não se negocia](#a-regra-que-não-se-negocia)

## Propósito

> Escrito em 2026-08-09, depois que a sessão da máquina de build acumulou cinco > frentes independentes. Existe porque a colisão que já aconteceu neste repo — > duas migrations com o mesmo número, escritas em branches diferentes — não é > evitável por atenção, só por combinação.
